...
return [
    ...
    'db_update' => [[], ['_controller' => 'App\\Controller\\DbController::updateDb'], [], [['text', '/db/update']], [], [], []],
    'update_db_by_id' => [['id'], ['_controller' => 'App\\Controller\\DbController::updateDbById'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/db/update']], [], [], []],
    'db_show_all' => [[], ['_controller' => 'App\\Controller\\DbController::showAllDb'], [], [['text', '/db/show']], [], [], []],
    'db_restore' => [[], ['_controller' => 'App\\Controller\\DbController::restoreDb'], [], [['text', '/db/restore']], [], [], []],
    'db_reset' => [[], ['_controller' => 'App\\Controller\\DbController::dbTest'], [], [['text', '/db/reset']], [], [], []],
    'kill_session' => [[], ['_controller' => 'App\\Controller\\DbController::killSession'], [], [['text', '/proj/kill-session']], [], [], []],
    ...
    'bj_hit' => [[], ['_controller' => 'App\\Controller\\HitBjController::hit'], [], [['text', '/proj/hit']], [], [], []],
    'bj_stand' => [[], ['_controller' => 'App\\Controller\\HitBjController::stand'], [], [['text', '/proj/stand']], [], [], []],
