...
/* test.html.twig */
class __TwigTemplate_c21ffb7ddd3e8afe7d92191e88c51747 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<h1>value: ";
        echo twig_escape_filter($this->env, (isset($context["hej"]) || array_key_exists("hej", $context) ? $context["hej"] : (function () { throw new RuntimeError('Variable "hej" does not exist.', 6, $this->source); })()), "html", null, true);
        echo "</h1>
";
...
{% block body %}
<h1>value: {{ hej }}</h1>
{% endblock %}", "test.html.twig", "/home/david/dbwebb-kurser/mvc/me/report/templates/test.html.twig");
    }
}
